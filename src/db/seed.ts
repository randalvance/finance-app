...
async function seed () {
  ...
  await db.insert(accounts)
    .values([
      { userId, name: "Personal", description: "Personal transactions and purchases", color: "#3b82f6", currency: "USD" },
      { userId, name: "Business", description: "Business-related transactions", color: "#10b981", currency: "USD" },
      { userId, name: "Family", description: "Family and household transactions", color: "#ec4899", currency: "SGD" },
    ])
    .onConflictDoNothing();
